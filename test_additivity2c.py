...
class PresetTests(Enum):
    ...
    FAHE2_QUANTUM_SMALL_MSG_SMALL_ALPHA = (256, 32, 33, 10, 21, 28, 2, 2364110189, False)
    FAHE1_CLASSICAL_LONG_MSG_SMALL_ALPHA = (128, 64, 33, 10, 21, 28, 1, 2364110189, False)
    FAHE2_CLASSICAL_LONG_MSG_SMALL_ALPHA = (128, 64, 33, 10, 21, 28, 2, 2364110189, False)
    FAHE1_QUANTUM_LONG_MSG_SMALL_ALPHA = (256, 64, 33, 10, 21, 28, 1, 2364110189, False)
    FAHE2_QUANTUM_LONG_MSG_SMALL_ALPHA = (256, 64, 33, 10, 21, 28, 2, 2364110189, False)
