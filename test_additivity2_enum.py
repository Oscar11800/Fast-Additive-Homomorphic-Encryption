...
class PresetTests(Enum):
    ...
    #   SET_MSG,
    #   IS_RAND_MSG)
    TEST1 = (128, 32, 6, 1, 21, 28, 2, 2364110189, False)
    ...
    # ...
    @classmethod
    def preset_dict(self, enum_member):
        preset_tuple = enum_member.value
        ...
        ret_dict = dict(zip(keys, preset_tuple))
        return ret_dict
    
    def run_preset(self, enum_member):
        preset_values = self.enum_member
        # ... run the test based on preset_values
