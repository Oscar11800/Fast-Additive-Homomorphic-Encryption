...
lambdas, keygen_times, enc_times, dec_times, total_times, clengths = lambda_performance_1(2, 100, 1, rep, 32, 32, m)
...
m_maxs, keygen_times, enc_times, dec_times, total_times, clengths = m_max_performance_1(2, 100, 1, rep, 32, 32, m)
...
alphas, keygen_times, enc_times, dec_times, total_times, clengths = m_max_performance_1(2, 100, 1, rep, 32, 32, m)
